...
class RegistrationForm(forms.ModelForm):
    ...
    email = forms.EmailField(max_length=100, help_text='Required', error_messages={'required': 'Sorry, you will need to enter email'})
    ...
    def clean_email(self):
        ...
        if not u:
            raise forms.ValidationError(
                'We cannot find the entered email address '
            )
        return email
